...
pub fn add_padlock(mut commands: Commands, locked: Query<&Transform, Added<Locked>>) {
    for transform in locked.iter() {
        ...
        let transform = Transform{
            ...
            translation: Vec3::new(transform.translation.x, transform.translation.y, transform.translation.z + 1.0)            
        };
        commands.spawn(GeometryBuilder::build_as(
            ...
            DrawMode::Fill(FillMode { options: FillOptions::DEFAULT, color: Color::BLACK }),// ::Stroke(StrokeMode::new(Color::BLACK, 4.0)),
            transform.clone(),
        ))
        .insert(Padlock{});
    }
...
pub fn remove_padlock(mut commands: Commands, padlock: Query<Entity, With<Padlock>>, unlocked: RemovedComponents<Locked>){
