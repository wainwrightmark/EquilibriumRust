...
function getImports() {
    ...
    imports.wbg.__wbindgen_closure_wrapper55325 = function(arg0, arg1, arg2) {
        const ret = makeMutClosure(arg0, arg1, 23217, __wbg_adapter_52);
        return addHeapObject(ret);
    };
...
async function init(input) {
    if (typeof input === 'undefined') {
        input = new URL('equilibrium-139bf1f8210075f3_bg.wasm', import.meta.url);
    }
    const imports = getImports();
